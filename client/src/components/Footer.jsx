...
const Footer = () => {
    ...
    const handleSubscribe = ()=>{
        setInput("")
        toast.success("Your Email Is Subscribe")
    }
  return (
            ...
            <div>
                ...
                <div class="text-sm space-y-2">
                    ...
                    <div className="flex items-center gap-2 pt-4">
                        ...
                        <button onChange={(e)=>setInput(e.target.value)}  onClick={handleSubscribe} className="bg-[#5044e5] w-24 h-9 text-white rounded cursor-pointer">Subscribe</button>
                    </div>
                </div>
            </div>
        </div>
